...
import com.jfsiot.hsgallery.util.data.db.DBHelper;
...
public class DBOpenHelper{
    ...
    public long insertColumnUseLog(UseLog useLog){
        ...
        values.put(Tables.UseLog.TO_DATA, useLog.to_data);
        values.put(Tables.UseLog.NOTE, useLog.note);
        values.put(Tables.UseLog.SHARE, useLog.share);
        return sqlite.insert(Tables.UseLog._TABLENAME, null, values);
    }

    public void refreshUseLog(){
        this.dbHelper.onRefresh(sqlite);
    }
